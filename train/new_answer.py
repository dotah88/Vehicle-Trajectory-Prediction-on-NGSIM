...
df = pd.read_csv("/home/mt/learn/NGSIM数据处理/csv/合并数据/Double_train1.csv")
f=pd.read_csv("/home/mt/learn/NGSIM数据处理/csv/合并数据/Double_label1.csv")
...
def train_data(data,label,data_num):
    ...
    x_train = np.reshape(x_train, [train_data_num, total_frame, 7])
...
# model.save('/home/mt/learn/NGSIM数据处理/model/train2.h5')
